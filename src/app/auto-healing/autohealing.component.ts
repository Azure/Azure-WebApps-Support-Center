...
export class AutohealingComponent extends DetectorViewBaseComponent implements OnInit {
  ...
  validateAutoHealRules() {
    ...
    const appDomainRestartWarning:string = "Saving mitigation settings will restart the application domain for the web app and this can cause logged in users information, sessions and in memory cache to be cleared. Hence, it is advised to make these changes during non-business hours.";
